...
export default function Login() {
  ...
  function onSignIn() {
    // TODO: POST credentials. On 401 -> setError("Invalid credentials. Please try again.").
    // On success the backend sends a 6-digit code, so we go to the verify screen.
    router.push("/verify");
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.tagline}>Enter your credentials to access your vault.</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={[styles.inputRow, error && styles.inputRowError]}>
            <Ionicons name="lock-closed-outline" size={18} color={error ? RED : MUTED} />
            <TextInput
              style={styles.input}
              value={password}
              onChangeText={(t) => {
          ...
          <View style={styles.actionRow}>
            ...
            <Pressable
              ...
              onPress={() => { /* TODO: expo-local-authentication */ }}
            >
...
const styles = StyleSheet.create({
  ...
  tagline: { color: MUTED, fontSize: 14, marginTop: 8, marginBottom: 24, textAlign: "center" },
  ...
  label: { color: MUTED, fontSize: 11, fontWeight: "700", letterSpacing: 1, marginTop: 10 },
